...
- a new questions block within the existing content one to reduce code in form pages
...
- the "secret" 'settings.scss' file, use this to override default values, should make rebranding easier
- a link in the footer to the current page on your hosted prototype
- a link in the footer to the git repository

> Both the hosted prototype and the repo URLs are configured in session-data-defaults.js file.
